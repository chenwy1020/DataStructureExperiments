...
//函数声明 
void SelectPass(SqList &L,int i); //选择排序 
void SelectSort(SqList &L);

void InsertPass(SqList &L,int i); //插入排序 
...
void MaxHead(SqList &L,int s,int t);	//堆排序 
void HeadSort(SqList &L);

void RadixPass1(RcdType A[],RcdType B[],int n);		//基数排序 
void RadixPass2(RcdType A[],RcdType B[],int n);
void RadixSort(SqList &L);


void counting_sort(RcdType A[], RcdType B[], int n, int m); //计数排序 
